 ...
 * ================================================================================
 * ✅ NOTES (LOCKED):
 * - Hosted end-point after Supabase email verification.
 * - Purpose: never show blank/black screen; always show a clean confirmation page.
 * - Includes deep link button back to the app: tissca://auth/callback
